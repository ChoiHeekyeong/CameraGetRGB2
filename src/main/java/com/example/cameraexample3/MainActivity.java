package com.example.cameraexample3;
/*
 원본 코드
...
//        }
    ...
    private final ImageReader.OnImageAvailableListener mOnImageAvailableListener = new ImageReader.OnImageAvailableListener() {
        ...
        public void onImageAvailable(ImageReader reader) {
            ...
            try {
                Toast.makeText(MainActivity.this, "RGB값을 구하기 시작합니다.", Toast.LENGTH_SHORT).show();
                getImageInform(bitmap); //RGB값 구하기
                Toast.makeText(MainActivity.this, "RGB값을 구하기 완료.", Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                e.printStackTrace();
            }

//            //여기가 RGB값 구하는 코드
//            int width = mDSI_width;
//            int height = mDSI_height;
//            for(int i = 0 ;i<width;i++) {
//                for (int j = 0; j < height; j++) {
//                    int rgb = bitmap.getPixel(i, j); //원하는 좌표값 입력
//                    int R = Color.red(rgb); //red값 추출
//                    int G = Color.green(rgb); //green값 추출
//                    int B = Color.blue(rgb); //blue값 추출
//                    Log.d("[RGB] pixel", "[" + i + "," + j + "]" + ": (R:" + R + ", G:" + G + ", B:" + B + ")");
//                }
//            }
    ...
    private void getImageInform(Bitmap bitmap) throws IOException {
